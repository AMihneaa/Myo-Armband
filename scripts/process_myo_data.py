...
IEVD_L      = 25
IEVD_K      = 10
BP_BANDS    = [(10,25),(25,40),(40,65),(65,95)]
BP_LOW      = 10.0
BP_HIGH     = 95.0
ENV_CUTOFF  = 10.0


def process_file(parquet_path) ->  pd.DataFrame:
    ...
    return pd.concat([df_meta, df_feat], axis= 1)
...
if __name__ == "__main__":
    ...
    df= process_file(parquet_path= parquet_path)
